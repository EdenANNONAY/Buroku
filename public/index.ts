...
let X =  (<HTMLInputElement>document.getElementById('inputX')).value;

let Y =  (<HTMLInputElement>document.getElementById('inputY')).value;
...
btn.addEventListener("click", function(){
    ...
    X =  (<HTMLInputElement>document.getElementById('inputX')).value;
    Y =  (<HTMLInputElement>document.getElementById('inputY')).value;
